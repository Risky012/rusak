...
$headers[] = 'X-Location: -6.209638,106.846131';

        echo "\n";
        echo "\e[92m--------------------------------------------------\n";
        echo "\e[31m|                PASTI ADA JALAN                 |\n";
        echo "\e[35m|         Recode doesn't make you a pro          |\n";
        echo "\e[32m|         Thanks to Netwezen Revolution          |\n";
        echo "\e[33m|                Author : eziii                  |\n";
        echo "\e[92m--------------------------------------------------\n";
        echo "\n";
        ulang:
...
echo "\e[96m[!] Mencoba Reedem Voucher 20+10 : GOJEKGRATIS20 \n";
$data3 = '{"promo_code":"GOJEKGRATIS20"}';
...
echo "\e[96m[!] Mencoba Reedem Voucher 15+10 : COBAGOJEK2020 \n";
...
sleep(5);
echo "\n";
 echo "\e[96m[!] Mencoba Redeem Voucher 10+10 : PAKAIGOJEK01 \n";
 $data5 = '{"promo_code":"PAKAIGOJEK01"}';
...
echo "\e[91m [×] Gagal Claim Voucer !";
    ...
    {
        echo color("red","[×] Salah OTPmu broo");
        echo"\n==================================\n\n";
        echo color("yellow","[!] Liat bae bae itu kode\n");
        goto otp;
    }
                    
                } else
                    {
                        echo color("red","[×] So ta daftar nomormu");
                        echo"\n==================================\n\n";
                        echo color("yellow","[!] Cari nomor lain jo\n");
                        goto ulang;
                    }   
